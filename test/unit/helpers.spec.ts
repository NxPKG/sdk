...
describe('replaceAndEmbed', () => {
  ...
  test('replaces target element with iframe', () => {
    const embedSrc = 'https://nxpkg.com/edit/test?embed=1';
    const target = h('div', {
      id: 'embed',
      class: 'test',
      'data-old': 'true',
