...
describe('openProjectId', () => {
  test('calls window.open', () => {
    ...
    openProjectId('js');
    expect(openSpy).toBeCalledWith('https://nxpkg.github.io/edit/js', '_blank');
...
describe('openGithubProject', () => {
  test('calls window.open', () => {
    ...
    expect(openSpy).toBeCalledWith('https://nxpkg.github.io/github/nxpkg/sdk', '_blank');

    openGithubProject('nxpkg/docs', { newWindow: false, hideExplorer: true });
    expect(openSpy).toBeCalledWith(
      'https://nxpkg.github.io/github/nxpkg/docs?hideExplorer=1',
      '_self'
    );
